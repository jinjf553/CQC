...
function footerScript() {
	...
	wp_register_style( 'style', get_template_directory_uri().'/style.css',false,33);
...
// 添加图片alt+title信息,已有alt+title的情况下不添加
add_filter('the_content', 'img_info');
function img_info ($img_info){
$pattern = "/<img(.*?)alt=('|\")('|\")(.*?)src=('|\")([^>]*).(bmp|gif|jpeg|jpg|png)('|\")(.*?)>/i";
$replacement = '<img$1alt=$2'.get_the_title().'$3$4 src=$5$6.$7$8 title="'.get_the_title().'"$9>';
